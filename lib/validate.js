...
var Model = module.exports = {
   ...
   * - if (Function(instance, value)): Skip validator when `if` returns false.
   * - unless (Function(instance, value)): Skip validator when `unless` returns true.
  **/
  ...
  **/
  ...
  custom: function(name, options, fn) {
    options = options || {};
    var message = options.message || name + ' is invalid';
