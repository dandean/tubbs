    ...
    validation.forEach(function(v) {
      ...
      if (validators) {
        ...
        if (v.confirmation) {
          ...
          Object.defineProperty(Type.prototype, Type.prototype[v.fieldName + 'Confirmation'], {
            value: undefined,
            enumerable: false,
            configurable: false
          });
...
Object.defineProperties(Model.prototype, {
  ...
  inspect: {
    value: function() {
      var primaryKey = this.__type.primaryKey;
      var out = 'Model<#';
  ...
  validate: {
    value: function(cb) {
      ...
      var next = function() {
        ...
        validator.function(t, t[name], function(message) {
          if (message) {
            if (!t.errors[name]) {
              t.errors[name] = [];
            }
...
// User.where("dandean", "me@dandean.com",
//   function(doc, username, email) {
