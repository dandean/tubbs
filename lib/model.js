...
Tubbs.define = function(options) {
  ...
  Object.defineProperty(Model.prototype, 'emit', {
    value: function(type, args) {
      var result = emit.apply(this, arguments);

      args = Array.prototype.slice.call(arguments);
      args.splice(1, 0, this);
      emit.apply(Model, args);
...
/**
 * Tubbs.fetch([options], [cb])
 * - options (Object): Request options.
 * - cb (Function(e)): Callback function.
 *
 * Fetch model data, if model data store supports this method.
**/
Tubbs.fetch = function(options, cb) {
  if (!this.dataStore) {
  ...
  } else this.dataStore.fetch(options, cb);
};
