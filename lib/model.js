...
Tubbs.define = function(options) {
  ...
  // I don't think we need this anymore with inheritence removed. Need to test.
  // Object.defineProperty(Model.prototype, 'fields', {
  //   // Add to the fields prototype chain so that the base type is not modified
  //   value: Object.create(Object.create(Model.prototype.fields)),
  //   enumerable: false,
  //   configurable: false
  // });
  ...
  if (options.initialize) {
    Object.defineProperty(Model.prototype, 'initialize', {
