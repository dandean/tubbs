...
Object.defineProperties(Model.prototype, {
  ...
  validate: {
    value: function(cb) {
      this.errors.splice(0); // Empty out the errors array
      var validators = [];
      ...
      // TODO: async iterate through ALL validators
      ...
      var next = function() {
        ...
        validator.function(t[validator.field], function(message) {
          if (message) {
